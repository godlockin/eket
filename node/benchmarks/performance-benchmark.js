...
import { LRUCache } from '../dist/core/cache-layer.js';
import { FileMessageQueue } from '../dist/core/message-queue.js';
...
function benchmarkLRUCache() {
  ...
  const cache = new LRUCache({ maxSize: 10000, defaultTTL: 300000 });
