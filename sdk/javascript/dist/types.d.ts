 ...
 */
export type AgentType = 'claude_code' | 'openclaw' | 'cursor' | 'windsurf' | 'gemini' | 'custom';
/**
 ...
 */
export type AgentSpecialty = 'frontend' | 'backend' | 'fullstack' | 'qa' | 'devops' | 'designer' | 'general';
/**
 * Agent status
 */
 ...
 * Task types
 */
export type TaskType = 'feature' | 'bugfix' | 'task' | 'test' | 'doc' | 'refactor';
/**
 * Task priorities
 */
 ...
 * Message types
 */
export type MessageType = 'pr_review_request' | 'task_claimed' | 'help_request' | 'status_update' | 'task_assigned' | 'pr_approved' | 'pr_rejected' | 'blocker_alert';
/**
 * Message priority
 */
