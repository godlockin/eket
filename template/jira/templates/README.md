...
| 模板 | 用途 | 位置 |
|------|------|------|
| [Feature Ticket](./feature-ticket.md) | 功能开发任务 | `jira/templates/feature-ticket.md` |
| [Task Ticket](./task-ticket.md) | 一般任务（文档/重构等） | `jira/templates/task-ticket.md` |
| [Bugfix Ticket](./bugfix-ticket.md) | 缺陷修复任务 | `jira/templates/bugfix-ticket.md` |
