...
│                                                                 │
│  ═══════════════════════════════════════════════════════════    │
│  等待 PR 期间的主动工作（v2.1.4）                                │
│  ═══════════════════════════════════════════════════════════    │
│  8. 同步/修正 roadmap → 对齐当前进度                             │
│       ↓                                                         │
│  9. 规划下阶段任务 → 创建 Sprint 草案                             │
│       ↓                                                         │
│  10. 拆解新需求 → Ticket 级别                                     │
│       ↓                                                         │
│  11. 标记 Ticket 优先级和依赖                                      │
│       ↓                                                         │
│  12. 预初始化 Slaver 团队 → 保持 ready 状态                        │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
...
**等待 PR 期间的主动工作（v2.1.4）**：Master 在等待 PR 反馈期间**不是被动等待**，而是主动执行项目管理和规划工作。详见 [MASTER-HEARTBEAT-CHECKLIST.md](./MASTER-HEARTBEAT-CHECKLIST.md) 的"等待 PR Review 期间的主动工作"章节。
