...
**Slaver 是被 Master 通过 subagent 唤醒的执行节点**，在运行中必须不断问自己 3 个问题：

1. **我现在手上的任务是什么？有没有依赖需要报告 Master？**
2. **我做完之后下一个任务可以是什么？**
3. **当前任务有没有优化的可能？**

📄 详细心跳检查清单：[`SLAVER-HEARTBEAT-CHECKLIST.md`](./SLAVER-HEARTBEAT-CHECKLIST.md)
